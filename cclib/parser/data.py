...
class ccData:
    ...
    _attributes = {
       ...
       "finalspenergies":  Attribute(numpy.ndarray,    'TBD',   'N/A'),
       ...
       "g4_energy":        Attribute(float,            'TBD',                         'N/A'),
       ...
       "molecular_mass":   Attribute(float,            'TBD',                         'N/A'),
       ...
       "nmr_anis":         Attribute(numpy.ndarray,    'TBD',                         'N/A'),
       "nmrcouplingtensors":Attribute(dict,            'TBD',                         'N/A'),
       "nmr_eigen":        Attribute(numpy.ndarray,    'TBD',                         'N/A'),
       "nmr_iso":          Attribute(numpy.ndarray,    'TBD',                         'N/A'),
       "nmrtensors":       Attribute(dict,             'TBD',                         'N/A'),
       ...
       "oniom_energy":     Attribute(list,             'TBD',                         'N/A'),
       "oniom_energy_fin": Attribute(float,            'TBD',                         'N/A'),
       "optdone":          Attribute(list,             'done',                        'optimization'),
       "optstatus":        Attribute(numpy.ndarray,    'status',                      'optimization'),
       "point_group":      Attribute(str,              'TBD',                         'N/A'),
       ...
       "rotconsts":        Attribute(numpy.ndarray,    'rotational constants',        'properties:rotconsts'),
       "rottemp":          Attribute(numpy.ndarray,    'TBD',                         'N/A'),
       "s2_after_anni":    Attribute(numpy.ndarray,    'TBD',                         'N/A'),      
       "s2_after_anni_fin":Attribute(float,            'TBD',                         'N/A'),      
       "s2_before_anni":   Attribute(numpy.ndarray,    'TBD',                         'N/A'),      
       "s2_before_anni_fin":Attribute(float,           'TBD',                         'N/A'),      
       ...
       "symmno":           Attribute(int,              'TBD',                         'N/A'),
       "td_energy":        Attribute(list,             'TBD',                         'N/A'),
       "td_energy_fin":    Attribute(float,            'TBD',                         'N/A'),
       "temperature":      Attribute(float,            'temperature',                 'properties'),
       "time":             Attribute(numpy.ndarray,    'time',                        'N/A'),
       "times_converged":  Attribute(numpy.ndarray,    'TBD',                         'N/A'),
       ...
       "WBO_matrix":       Attribute(numpy.ndarray,    'TBD ',                        'N/A'),
