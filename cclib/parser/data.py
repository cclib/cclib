...
class ccData:
    ...
    _attributes = {
       ...
       "finalspenergies":  Attribute(numpy.ndarray,    'final single point energy',   'properties:energy'),
       ...
       "nmr_anis":         Attribute(numpy.ndarray,    'NMR anisotopic tensors',      'properties:NMR'),
       "nmrcouplingtensors":       Attribute(dict,             'NMR spin-spin coupling tensors', 'properties:NMR'),
       "nmr_eigen":        Attribute(numpy.ndarray,    'NMR eigenvalues',             'properties:NMR'),
       "nmr_iso":          Attribute(numpy.ndarray,    'NMR isotopic tensors',        'properties:NMR'),
       ...
       "rottemp":           Attribute(numpy.ndarray,    'rotational temperatures',     'properties:rottemp'),
       ...
       "s2_before_anni_fin": Attribute(float,          'S2 before annihilation',      'properties'),      
