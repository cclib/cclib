...
_L = dict(
    [(prim_type, 0) for prim_type in range(1, 2)]
    + [(prim_type, 1) for prim_type in range(2, 5)]  # s
    + [(prim_type, 2) for prim_type in range(5, 11)]  # p
    + [(prim_type, 3) for prim_type in range(11, 21)]  # d
    + [(prim_type, 4) for prim_type in range(21, 36)]  # f  # g
)
