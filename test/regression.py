...
def testQChem_QChem5_3_ts_30_out(logfile):
    ...
    # This is the structure for the analytic frequency calculation preceding
    # the IRC calculation.
    assert positive_path[0] == 24
    numpy.testing.assert_allclose(logfile.data.atomcoords[23], logfile.data.atomcoords[24])
