...
class XYZWriterTest:
    ...
    def test_roundtrip_1(self) -> None:
    ...
    def test_roundtrip_2_allgeom(self) -> None:
        ...
        ref_fpath = os.path.join(__filedir__, "data/uracil_two_ref_allgeom.xyz")
        with open(ref_fpath) as ref:
            assert ref.read() == new_repr

    def test_roundtrip_2_first(self) -> None:
        """Does a written XYZ file with two structures match a reference
        output where only the first structure is requested?
        ...
        writer = cclib.io.xyzwriter.XYZ(data, firstgeom=True)
        new_repr = writer.generate_repr()

        ref_fpath = os.path.join(__filedir__, "data/uracil_two_ref_firstgeom.xyz")
        with open(ref_fpath) as ref:
            assert ref.read() == new_repr

    def test_roundtrip_2_last(self) -> None:
        """Does a written XYZ file with two structures match a reference
        ...
        writer = cclib.io.xyzwriter.XYZ(data, lastgeom=True)
        new_repr = writer.generate_repr()
    ...
    def test_roundtrip_10_defaults(self) -> None:
    ...
    def test_roundtrip_10_first(self) -> None:
        """Does a written XYZ file with ten structures match a reference
        output where only the first structure is requested?
    ...
    def test_roundtrip_10_last(self) -> None:
        """Does a written XYZ file with ten structures match a reference
        output where only the last structure is requested?
