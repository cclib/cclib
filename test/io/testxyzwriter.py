...
class XYZWriterTest:
    ...
    def test_roundtrip_2_allgeom(self):
    ...
    def test_roundtrip_2_first(self):
        """Does a written XYZ file with two structures match a reference
    ...
    def test_roundtrip_2_last(self):
        """Does a written XYZ file with two structures match a reference
    ...
    def test_roundtrip_10_first(self):
    ...
    def test_roundtrip_10_last(self):
        """Does a written XYZ file with ten structures match a reference
        output where only the last structure is requested?
