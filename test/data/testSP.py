...
class GenericSPTest(unittest.TestCase):
    ...
    @skipForParser('NBO', 'attribute not implemented in this version')
    @skipForParser('NWChem/basicNWChem6.0', 'Not implemented yet')
    @skipForParser('NWChem/basicNWChem6.1', 'Not implemented yet')
    @skipForParser('NWChem/basicNWChem6.5', 'Not implemented yet')
    @skipForParser('NWChem/basicNWChem6.6', 'Not implemented yet')
    @skipForParser('NWChem/basicNWChem6.8', 'Not implemented yet')
