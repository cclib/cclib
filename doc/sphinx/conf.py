...
latex_documents = [
    ("index", "cclib.tex", "cclib Documentation", "cclib Development Team", "manual")
]
...
man_pages = [("index", "cclib", "cclib Documentation", ["cclib Development Team"], 1)]
