 ...
 * A .zip file: https://github.com/cclib/cclib/releases/download/v1.5.3/cclib-1.5.3.post1.zip
 * A .tar.gz file: https://github.com/cclib/cclib/releases/download/v1.5.3/cclib-1.5.3.post1.tar.gz
